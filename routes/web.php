...
Route::controller(ClientController::class)->group(function(){
    ...
    Route::post('/check-voucher', 'checkVoucher')->name('clientCheckVoucher');
    Route::post('/apply-voucher', 'applyVoucher')->name('clientApplyVoucher');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::controller(VoucherController::class)->group(function() {
        Route::get('/admin/vouchers', 'index')->name('vouchers');
        Route::get('/admin/vouchers/create', 'create')->name('voucherCreate');
        Route::post('/admin/vouchers/save', 'save')->name('voucherSave');
        Route::post('/admin/vouchers/update/{voucher_code}', 'update')->name('voucherUpdateStatus');
        Route::get('/admin/vouchers/delete/{name}', 'delete')->name('voucherDelete');
        Route::get('/admin/vouchers/edit/{name}', 'edit')->name('voucherEdit');
        Route::post('/admin/vouchers/edit/{voucher}/{id}/save', 'editSave')->name('voucherEditSave');
