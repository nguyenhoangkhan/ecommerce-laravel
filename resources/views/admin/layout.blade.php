            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item {{ request()->routeIs('vouchers') ? 'active' : '' }}">
                            <a href="{{route('vouchers')}}" class='sidebar-link'>
                                <i class="bi bi-shop"></i>
                        ...
                        <li class="sidebar-item has-sub mt-5">
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item ">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#modalUpdatePassword">Đổi mật khẩu</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="{{ route('logout') }}"
        ...
        <div class="modal fade" id="modalUpdatePassword" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalUpdatePasswordLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalUpdatePasswordLabel">Cập nhật mật khẩu</h5>
