...
@section('content')
      ...
      <div class="col-md-6 col-12">
        <form method="post" action="{{route('productAddImagesSave')}}" enctype="multipart/form-data" class="dropzone mt-4" id="dropzone" style="border-radius:12px;">
          ...
          <div class="dz-message" data-dz-message>
            <span>Tải lên thư viện sản phẩm</span><br>
  ...
  <div class="card">
    <div class="card-body">
      <a href="javascript:void(0)" onClick="deleteProduct('{{ route('productDelete', $product->id) }}')" class="btn btn-danger float-end">Xóa</a>
    </div>
  </div>
@endsection
@section('js')
