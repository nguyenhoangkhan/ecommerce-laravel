    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-6 ">
          <h6>Công ty</h6>
          <a href="/about" class="text-decoration-none"><p>Giới thiệu</p></a>
          <a href="/products" class="text-decoration-none"><p>Sản phẩm</p></a>
          <a href="/about#address" class="text-decoration-none text-dark"><p>Địa chỉ</p></a>
        </div>
        <div class="col-lg-3 col-md-3 col-6 ">
          <h6>Hỗ trợ</h6>
          <a href="/about#faq" class="text-decoration-none text-dark"><p>FAQ</p></a>
          <a href="/about#shippingandreturns" class="text-decoration-none text-dark"><p>Giao hoàn</p></a>
          <a href="/about#warranty" class="text-decoration-none text-dark"><p>Bảo hành</p></a>
        </div>
        <div class="col-lg-2 col-md-2 col-6 d-flex flex-column">
          ...
          <p class="d-flex align-items-center"><img src="{{ asset('client/img/icon-email.png') }}" alt="" class="img-fluid me-2">chào{!! '@'.str_replace(' ', '', strtolower($shop->name_shop)) !!}.com</p>
