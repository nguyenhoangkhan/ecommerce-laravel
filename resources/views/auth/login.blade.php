            ...
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    @csrf
                        ...
                        <button type="submit" class="btn btn-primary btn-block btn-lg shadow-lg mt-3">Đăng nhập</button>
                    </form>
                    <div class="text-center mt-5 text-lg">
                        <p class='text-gray-600'>Chưa có tài khoản? <a href="/register" class="font-bold">Đăng kí</a>.</p>
                    </div>
                </div>
            </div>
