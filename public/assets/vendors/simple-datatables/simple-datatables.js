                ...
                function (require, module, exports) {
                    (function (global) {
                        ...
                        var dayjs_min = createCommonjsModule(function (t, n) {
                            ...
                            customParseFormat = createCommonjsModule(function (
                                t,
                                n
                            ) {
                ...
                function (require, module, exports) {
                    ...
                    const isObject = (t) =>
                        ...
                        truncate = (t, e, s, a, i) => {
                            ...
                            return (
                                o.forEach((e) => {
                                    const s =
                                        e.children[0].getAttribute("data-page");
                                    if (n) {
                                        const e =
                                            n.children[0].getAttribute(
                                                "data-page"
                                            );
                                        if (s - e == 2) d.push(t[e]);
                                        else if (s - e != 1) {
                    ...
                    class Columns {
                        ...
                        order(t) {
                            ...
                            t.forEach((t, a) => {
                                (n = o.headings[t]),
                                    ...
                                    ((e = n.cloneNode(!0)).originalCellIndex =
                                        a),
                                    (e.sortable = l),
                                    h[0].push(e),
                                ...
                                o.data.forEach((e, s) => {
                                    (a = e.cloneNode(!1)),
                                        ...
                                        null !== e.searchIndex &&
                                            ...
                                            (a.searchIndex = i.searchIndex =
                                                e.searchIndex),
                                        t.forEach((t) => {
                                            ((r = e.cells[t].cloneNode(
                                                !0
                                            )).data = e.cells[t].data),
                                                a.appendChild(r),
                                                o.hiddenColumns.includes(t) ||
                        ...
                        filter(t, e, s, a) {
                            ...
                            if (
                                (i.filterState ||
                                    (i.filterState = { originalData: i.data }),
                                !i.filterState[t])
                            ) {
                                const e = [...a, () => !0];
                        ...
                        sort(t, e, s) {
                            ...
                            if (i && 0 !== i.length)
                                return void this.filter(t, e, s, i);
                            (a.sorting = !0),
                            ...
                            (i.activeRows = []),
                                ...
                                i.headings.forEach((t, e) => {
                                    (t.originalCellIndex = e),
                                        ...
                                        i.hiddenColumns.includes(e) ||
                                            i.activeHeadings.push(t);
                                }),
                                i.data.forEach((l, r) => {
                                    (t = l.cloneNode(!1)),
                                        (e = l.cloneNode(!1)),
                                        ...
                                        Array.from(l.cells).forEach((n) => {
                                            ((s = n.cloneNode(!0)).data =
                                                n.data),
                                                t.appendChild(s),
                                                i.hiddenColumns.includes(
                                                    s.cellIndex
                                                ) ||
                                                    (((a = s.cloneNode(
                                                        !0
                    ...
                    class DataTable {
                        ...
                        render(t) {
                            ...
                            if (
                                ...
                                (t += e.labels.perPage),
                                    (t +=
                                        "<label>mục trên mỗi trang</label></div>");
                            ...
                            a.appendChild(i),
                                ...
                                this.table.parentNode.replaceChild(
                                    this.wrapper,
                                    this.table
                                ),
                        ...
                        renderPager() {
                            if ((flush(this.pagers), this.totalPages > 1)) {
                                ...
                                this.options.firstLast &&
                                    e.appendChild(
                                        button(t, 1, this.options.firstText)
                                    ),
                                    this.options.nextPrev &&
                                        e.appendChild(
                                            button(t, s, this.options.prevText)
                                        );
                                let i = this.links;
                                this.options.truncatePager &&
                                    ...
                                    this.options.nextPrev &&
                                        e.appendChild(
                                            button(t, a, this.options.nextText)
                                        ),
                                    this.options.firstLast &&
                                        e.appendChild(
                                            button(
                        ...
                        fixColumns() {
                            if (
                                ...
                                let t,
                                    e = !1;
                                if (
                                    ((this.columnWidths = []), this.table.tHead)
                                ) {
                                    if (
                                        (this.options.scrollY.length &&
                                            ((e =
                                        ...
                                        this.activeHeadings.forEach((t, s) => {
                                            ...
                                            if (
                                                ...
                                                e.firstElementChild.appendChild(
                                                    t
                                                ),
                                                    (t.style.width = `${i}%`),
                                        ...
                                        if (!this.headerTable) {
                                            this.headerTable = createElement(
                                                "table",
                                    ...
                                    const s = createElement("tr");
                                    Array.from(
                                        this.table.tBodies[0].rows[0].cells
                                    ).forEach(() => {
                        ...
                        insert(t) {
                            ...
                            e.length &&
                                (this.rows().add(e), (this.hasRows = !0)),
                                this.update(),
                                this.setColumns(),
                                this.fixColumns();
                        }
                                    ...
                                    if ("txt" === h.type || "csv" === h.type) {
                                        for (l = "", i = 0; i < s.length; i++) {
                                            for (
                                                ...
                                                if (
                                                    !h.skipColumn.includes(
                                                        e[n].originalCellIndex
                                                    ) &&
                                                    this.columns(
                                                        e[n].originalCellIndex
                                                    ).visible()
                                        ...
                                        (l = l
                                            ...
                                            .substring(0, l.length - 1)),
                                            h.download &&
                                                (l = `data:text/csv;charset=utf-8,${l}`);
                                    } else if ("sql" === h.type) {
                                        for (
                                            l = `INSERT INTO \`${h.tableName}\` (`,
                                                i = 0;
                                            i < e.length;
                                            i++
                                        )
                                            !h.skipColumn.includes(
                                                e[i].originalCellIndex
                                            ) &&
                                                this.columns(
                                                    e[i].originalCellIndex
                                                ).visible() &&
                        ...
                        print() {
                            ...
                            t.forEach((t) => {
                                n.appendChild(
                                    createElement("th", { html: t.textContent })
                                );
                            }),
                                a.appendChild(n),
                                e.forEach((t) => {
