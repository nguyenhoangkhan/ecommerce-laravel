...
class ProductController extends Controller
{
    ...
    public function create(){
        return view('admin.product.create', ['title' => 'Thêm sản phẩm']);
    }
    ...
    public function addImages($product){
        ...
        $data = [
            'title' => 'Thêm ảnh - '. str_replace('-', ' ', $product),
            'product' => $productData
        ];
    ...
    public function edit($product){
        ...
        $data = [
            'product' => $productData,
            'title' => 'Chỉnh sửa sản phẩm '. str_replace('-', ' ', $product)
        ];
